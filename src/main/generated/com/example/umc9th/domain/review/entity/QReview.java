...
public class QReview extends EntityPathBase<Review> {
    ...
    public final ListPath<ReviewAnswer, QReviewAnswer> reviewAnswers = this.<ReviewAnswer, QReviewAnswer>createList("reviewAnswers", ReviewAnswer.class, QReviewAnswer.class, PathInits.DIRECT2);
